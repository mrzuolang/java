package org.blog.conf;


public class Config {
	/**数据库url配置*/
    public static final String DB_URL = "jdbc:mysql://118.190.205.51/pk10?characterEncoding=utf8&serverTimezone=UTC";
    /**数据库名称*/
    public static final String DB_NAME="pk10";
    /**数据库用户名*/
