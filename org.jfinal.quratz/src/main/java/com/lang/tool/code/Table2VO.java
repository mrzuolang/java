...
public class Table2VO extends CommonVO{
	public List<ColumnVO> findColumns(String db_name, String tb_name) throws SQLException {
		...
		Connection conn =null;// ConnectionFactory.getConection();
